...
@SuppressLint("NewApi") public class MainFragment extends Fragment 
	...
	static public MainFragment newInstance(String startingMessage, 
		...
		/*args.putString(KEY_MESSAGE_INPUT_CONTENT, "12345");
		System.out.println("Value of: "+String.valueOf(UniqueCode));*/
		//System.out.println("Value Sent!!!!!!!!!!!!!!!!!!!!!!: "+ args);
	...
	public void onClick(View v) {
		UniqueCode = generateRandomValue();
		System.out.println("Send Button Clicked: "+UniqueCode);
		
		insertIntoDB();
		
		if(v.getId()==R.id.com_ovrhere_morseflash_frag_main_button_send)
			if (isSendingMessage){
