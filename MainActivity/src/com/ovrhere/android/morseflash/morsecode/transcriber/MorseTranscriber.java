...
public class MorseTranscriber implements IMorseTranscriber {
	...
	final private static int DEFAULT_UNIT_TIME = 250; //ms
	...
	final private static int REL_INTERVAL_DASH = 2; //units
	/** The relative interval between each morse letter. */
	//final private static int REL_INTERVAL_CHARACTER = 6; //original value
	final private static int REL_INTERVAL_CHARACTER = 2; //units
	/** The relative interval between each word. */
	//final private static int REL_INTERVAL_WORD = 14; //units
	final private static int REL_INTERVAL_WORD = 4; //units
